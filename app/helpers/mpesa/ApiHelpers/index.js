...
exports.genOAuth = (auth,TimeStamp,password) => {
    console.log("TIMESTAMP:",TimeStamp)
    console.log("Made it to gen oauth")
    return rp(
        {
            url:genoauthUrl,
...
exports.lipaNaMpesa = (auth,TimeStamp,password) => {
    console.log("TIMESTAMP:",TimeStamp)
    
    console.log("Made it to STK")
    return rp(
        {
            method:"POST",
            "rejectUnauthorized": false,
